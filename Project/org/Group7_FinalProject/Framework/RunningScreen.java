...
public class RunningScreen extends GameScreen implements ActionListener, KeyListener {
    ...
    public RunningScreen(Window w) {
    	...
    	super(w, new ImageIcon(Main.class.getResource("/resources/background.jpeg")));
	...
	/**
	 * @return the dIFFICULTY_DELAY
	 */
	public int getDIFFICULTY_DELAY() {
		return DIFFICULTY_DELAY;
	}

	/**
	 * @param dIFFICULTY_DELAY the dIFFICULTY_DELAY to set
	 */
	public void setDIFFICULTY_DELAY(int dIFFICULTY_DELAY) {
		DIFFICULTY_DELAY = dIFFICULTY_DELAY;
	}
	...
	/**
	 * @return the invincibilityDisplay
	 */
	public JLabel getInvincibilityDisplay() {
		return invincibilityDisplay;
	}

	/**
	 * @param invincibilityDisplay the invincibilityDisplay to set
	 */
	public void setInvincibilityDisplay(JLabel invincibilityDisplay) {
		this.invincibilityDisplay = invincibilityDisplay;
	}
